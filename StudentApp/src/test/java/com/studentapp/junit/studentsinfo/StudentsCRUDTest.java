...
public class StudentsCRUDTest extends TestBase {
	...
	static String firstName = "SomeUser"+TestUtils.getRandomValue();
	static String lastName = "ThingUser"+TestUtils.getRandomValue();
	static String programme = "Computer Science";
	static String email = TestUtils.getRandomValue()+"thing@gmail.com";
